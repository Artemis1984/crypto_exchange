...
#     r = requests.get('https://apiv2.bitz.com/Market/getContractCoin').json()
...
links = [
         'https://apiv2.bitz.com/Market/getContractOrderBook?contractId=102&depth=5',
         'https://api.aax.com/v2/market/orderbook?symbol=ETHUSDTFP&level=20'
         ]
...
while True:
    ...
    bid_list = dict()
    for i in data_list:
        if i == 'https://apiv2.bitz.com/Market/getContractOrderBook?contractId=102&depth=5':
            try:
                ask_list['bitz'] = []
        ...
        elif i == 'https://api.aax.com/v2/market/orderbook?symbol=ETHUSDTFP&level=20':
            try:
                ask_list['aax'] = []
    ...
    commissions = {'bitz': 0.06, 'aax': 0.04}

    long_profit = bid_list[long_platform][0] - long
    short_profit = short - ask_list[short_platform][0]
    total_profit = (long_profit - (long_profit * commissions[long_platform] / 100)) + (short_profit - (short_profit * commissions[short_platform] / 100))
